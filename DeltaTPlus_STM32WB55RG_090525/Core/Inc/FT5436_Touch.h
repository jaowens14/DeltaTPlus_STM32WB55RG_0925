/* This is a library to handling capacitive multitouch sensors using the FocalTech FT5436
   ...
   Adapted for STM32 HAL by [Your Name]
   Original created by Bodmer 17-04-2021
*/

#ifndef Touch_FT5436_STM32_H
#define Touch_FT5436_STM32_H
...
// HAL timeout for I2C operations (in milliseconds)
#define FT_I2C_TIMEOUT 100
...
typedef struct
{
    ...
    GPIO_TypeDef *int_port;  // Interrupt pin port
    uint16_t int_pin;        // Interrupt pin number

    uint8_t maxPoints; // How many multi-point touches will be reported
    uint8_t margin;    // Jitter margin
