...
#ifndef INC_WIDGETS_H_
#define INC_WIDGETS_H_
#include "lvgl.h"
#include <math.h>
#include "ST7789.h"
#include <accel.h>
...
#define WEB_LIGHT_TAN 0xD0EAF0
#define WEB_DARK_TAN 0xBEB89E
#define WEB_BLACK 0x382922
#define WEB_ORANGE 0xdf571d
#define Charcoal 0x000000 //0x36454F


extern lv_display_t *display1;
//int xValue;

extern uint8_t buffer1[ST7789_WIDTH * ST7789_HEIGHT / 4 * BYTE_PER_PIXEL];
extern uint8_t buffer2[ST7789_WIDTH * ST7789_HEIGHT / 4 * BYTE_PER_PIXEL];
...
void gauge(void);
void header(void);
void create_menu_icon_button(lv_obj_t * parent);
...
void menu_btn_cb(lv_event_t *e);

void create_menu_screen(void);
void switch_to_menu_screen(lv_event_t *e);
