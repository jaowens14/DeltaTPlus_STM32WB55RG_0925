...
typedef enum
{
  ...
  CUSTOM_STM_LED_C,
  CUSTOM_STM_SWITCH_C,
  CUSTOM_STM_REBOOT_REQUEST_CH,
  CUSTOM_STM_DELTA_T_CH,
...
typedef enum
{
  ...
  /* REBOOT_REQUEST_CHAR */
  CUSTOM_STM_REBOOT_REQUEST_CH_WRITE_NO_RESP_EVT,
  /* DELTA_T_CHAR */
  CUSTOM_STM_DELTA_T_CH_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_DELTA_T_CH_NOTIFY_DISABLED_EVT,
...
extern uint16_t SizeReboot_Request_Ch;
extern uint16_t SizeDelta_T_Ch;
