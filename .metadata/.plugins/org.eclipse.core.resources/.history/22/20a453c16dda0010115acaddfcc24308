...
void st7789_send_cmd(lv_display_t *disp, const uint8_t *cmd, size_t cmd_size,
                     const uint8_t *param, size_t param_size)
{
    /* Send command byte */
    ST7789_CS_LOW();
    ST7789_DC_LOW();  // Command mode
...
void st7789_send_color(lv_display_t *disp, const uint8_t *cmd, size_t cmd_size,
                       const uint8_t *param, size_t param_size)
{
    /* This is for sending large amounts of pixel data */
    /* Usually cmd is RAMWR (0x2C) */
    ...
    /* Send pixel data via DMA for better performance */
    ST7789_DC_HIGH();
    HAL_SPI_Transmit_DMA(&hspi1, (uint8_t*)param, param_size);

    /* Note: CS will be set HIGH in DMA complete callback */
}
